...
<svelte:head><title>Animation Project | Learnzur Create</title><meta name="description" content="Learners create animation projects through the Media engine." /></svelte:head>
<section class="page create-page">
  <p class="eyebrow">Create</p><h1>Animation Project</h1><p class="lead">Make simple animations with scenes, text, images, timing, preview, rendering, and public publishing after safety review.</p>
  <div class="studio-grid">
    <article class="card">
      ...
      <div class="actions"><button on:click={save}>Save draft</button><button class="primary" on:click={runOrRender}>Render animation</button><button on:click={publish}>Publish safely</button></div>
