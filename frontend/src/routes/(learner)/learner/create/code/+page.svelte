...
<svelte:head><title>Code Project | Learnzur Create</title><meta name="description" content="Learners create safe code projects with San sandbox execution." /></svelte:head>
<section class="page create-page">
  <p class="eyebrow">Create</p><h1>Code Project</h1><p class="lead">Build HTML, CSS, JS, PHP, SvelteKit, or MicroPython inside the San sandbox.</p>
  <div class="studio-grid">
    <article class="card">
      ...
      <div class="actions"><button on:click={save}>Save draft</button><button class="primary" on:click={runOrRender}>Run code</button><button on:click={publish}>Publish safely</button></div>
