...
<svelte:head><title>Movie Project | Learnzur Create</title><meta name="description" content="Learners create movie projects through the Media engine." /></svelte:head>
<section class="page create-page">
  <p class="eyebrow">Create</p><h1>Movie Project</h1><p class="lead">Upload clips and images, arrange them, add text and transitions, preview, render, and publish when approved.</p>
  <div class="studio-grid">
    <article class="card">
      ...
      <div class="actions"><button on:click={save}>Save draft</button><button class="primary" on:click={runOrRender}>Render movie</button><button on:click={publish}>Publish safely</button></div>
