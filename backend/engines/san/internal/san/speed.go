...
func SpeedRules() []string {
	...
	rules = append(rules, "san specific speed rule 1: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 2: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 3: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 4: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 5: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 6: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 7: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 8: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 9: keep engine work bounded, cacheable and queue-friendly.")
	rules = append(rules, "san specific speed rule 10: keep engine work bounded, cacheable and queue-friendly.")
	return rules
}

func DefaultSpeedProfile() SpeedProfile {
	return SpeedProfile{Engine: "san", CacheTTL: 5 * time.Minute, BatchSize: 100}
}
